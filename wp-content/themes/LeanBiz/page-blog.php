					...
					<div id="et_pt_blog">
						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<div class="et_pt_blogentry clearfix">
								...
								<p class="et_pt_blogmeta"><?php esc_html_e('Posted','LeanBiz'); ?> <?php esc_html_e('by','LeanBiz'); ?> <?php the_author_posts_link(); ?> <?php esc_html_e('on','LeanBiz'); ?> <?php the_time(get_option('leanbiz_date_format')) ?> <?php esc_html_e('in','LeanBiz'); ?> <?php the_category(', ') ?> | <?php comments_popup_link(esc_html__('0 comments','LeanBiz'), esc_html__('1 comment','LeanBiz'), '% '.esc_html__('comments','LeanBiz')); ?></p>
